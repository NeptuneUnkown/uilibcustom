		...
		task.spawn(function()
			...
			if options.KeySystem then
				...
				if Gui.DiscordLink ~= nil then
					...
					KeySystem["ad"]["Color"] = Color3.fromRGB(63, 182, 114)
					...
					do
						...
						KeySystem["ab"].MouseLeave:Connect(function()
							Library:Tween(KeySystem["ad"], {
								Length = 0.2,
								Goal = {Color = Color3.fromRGB(63, 182, 114)}
							})
						end)
						...
						KeySystem["ab"].MouseButton1Click:Connect(function()
							...
							task.spawn(function()
								...
								Library:Tween(KeySystem["ad"], {
									Length = 0.2,
									Goal = {Color = Color3.fromRGB(183, 215, 181)}
								})
								...
								Library:Tween(KeySystem["ad"], {
									Length = 0.2,
									Goal = {Color = Color3.fromRGB(137, 223, 138)}
								})
							end)
		...
		function Tab:Section(options)
					...
					UserInputService.InputBegan:Connect(function(input)
						if input.UserInputType == Enum.UserInputType.MouseButton1 and Button.Hover then
							...
							Library:Tween(Button["79"], {
								Length = 0.2,
								Goal = {ImageColor3 = Color3.fromRGB(109, 189, 58)}
							})
					...
					function Toggle:Toggle(toggle)
						if toggle then
							...
							task.spawn(function()
								...
								Library:Tween(Toggle["2a"], {
									Length = 0.2,
									Goal = {BackgroundColor3 = Color3.fromRGB(109, 189, 58)}
								})
							end)
			...
			function Section:Slider(options)
				...
				do
					...
					Slider["3e"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(29, 215, 43)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(65, 188, 63))}
